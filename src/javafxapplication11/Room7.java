...
public class Room7 extends Room {
    ...
    public void createWalls() {
        ...
        FloorMat mat = new FloorMat(690, 510, 75, 75);
    ...
    public void fillRoom() {
        ...
        int x = 40, y = 260;
        Bedroom vaseBrP = new Bedroom(x, y, 50, 55, "vaseBrP");
        Bedroom vaseBr = new Bedroom(x+60, y, 50, 55, "vaseBr");
        Bedroom vaseBP = new Bedroom(x+120, y, 50, 55, "vaseBP");
        Bedroom vaseB = new Bedroom(x+180, y, 50, 55, "vaseB");
        x +=520;
        Bedroom vaseBrP2 = new Bedroom(x, y, 50, 55, "vaseBrP");
        Bedroom vaseBr2 = new Bedroom(x+60, y, 50, 55, "vaseBr");
        Bedroom vaseBP2 = new Bedroom(x+120, y, 50, 55, "vaseBP");
        Bedroom vaseB2 = new Bedroom(x+180, y, 50, 55, "vaseB");
        ...
        //roomObjects.getChildren().addAll(vaseBrP, vaseBr, vaseBP, vaseB,vaseBrP2, vaseBr2, vaseBP2, vaseB2);
    }
